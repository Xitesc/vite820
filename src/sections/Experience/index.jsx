...
const Experience = () => {
    return (
        <div className="space-y-4">
           <div className="text-left text-primaryAccent font-medium">Exprience</div>
           <div className="grid grid-cols-[25%_75%] ">
            <div>
             ...
             <div className="text-left flex gap-4 text-sm">
                <div className="bg-primayTitle px-2 py-1 rounded-md text-gray-100 hover:text-primaryAccent">React</div>
                <div className="bg-primayTitle px-2 py-1 rounded-md text-gray-100 hover:text-primaryAccent">Tailwind</div>
            </div>
          </div>
       </div>
    </div>
